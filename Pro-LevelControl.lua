...
local function runMainScript()
    ...
    local Games = loadstring(game:HttpGet("https://rawscripts.net/raw/BACHIRAGAGAMARU-Azure-Latch-AZURE-LATCH-ADMIN-AND-UNRELEASED-STYLE-SCRIPT-HUGE-BUG-FIX-44560"))()
